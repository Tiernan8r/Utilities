...
public class UtilitiesMain extends JavaPlugin {
	...
	private void initialiseSQL() {
		...
		query = "CREATE TABLE IF NOT EXISTS Players ( " + "Name varchar(255) NOT NULL, " + "UUID varchar(36) NOT NULL" + ");";
		SQLServer.executeQuery(query);

		query = "CREATE TABLE IF NOT EXISTS PlayerTime ( " + "UUID varchar(36) NOT NULL," + "Time BIGINT NOT NULL" + ");";
		SQLServer.executeQuery(query);
