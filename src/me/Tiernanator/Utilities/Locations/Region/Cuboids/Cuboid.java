...
//			b.setData(material.getDamage());
	...
	//
	// /**
	// * Change all the solid blocks within the Cuboid to the given
	...
	//
	// /**
	// * Replace the blocks of a certain type within the Cuboid with another
	// type.
	// *
	// * @param original
	...
	// */
	// public void replace(BuildingMaterial original, BuildingMaterial
	// replacement) {
	//
	// for (Block b : this) {
