...
public enum Colour {
	...
	INFORMATIVE(ChatColor.AQUA), ALTERNATE_INFORMATIVE(ChatColor.DARK_PURPLE), HIGHLIGHT(ChatColor.LIGHT_PURPLE), ALTERNATE_HIGHLIGHT(ChatColor.DARK_AQUA), WARNING(ChatColor.DARK_RED), ALTERNATE_WARNING(ChatColor.RED), SEVERE(ChatColor.BLACK), GOOD(ChatColor.GREEN), ALTERNATE_GOOD(ChatColor.BLUE), CAUTION(ChatColor.GRAY), BAD(ChatColor.DARK_PURPLE), ALTERNATE_BAD(ChatColor.WHITE), REGAL(ChatColor.GOLD);

	private ChatColor colour;

	Colour(ChatColor colour) {
		this.colour = colour;
	}
	...
	public String getColourCode() {
		...
		String colourCode = parseChatColourToCode(getColour());
		return colourCode.replace("&", "§");
