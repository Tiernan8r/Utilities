...
public class CustomMaterial {
	//
	// private static List<CustomMaterial> allCustomMaterials = new
	// ArrayList<CustomMaterial>();
	// private static HashMap<String, CustomMaterial> customMaterialMap = new
	// HashMap<String, CustomMaterial>();
	//
	...
	// List<CustomMaterial> allCustomMaterials = new
	// ArrayList<CustomMaterial>();
	//
	...
	//
	// //Store the names of any sub items in the material e.g. red wool, blue
	// wool, etc...
	// List<String> thisMaterialsNames = new ArrayList<String>();
	// //A hashmap of the customMaterial to the item name
	// HashMap<String, CustomMaterial> thisCustomMaterialMap = new
	// HashMap<String, CustomMaterial>();
	//
	// //Iterate over the 16 available data values to represent colour and etc
	// in blocks
	// for (int i = 0; i < 16; i++) {
	// //Get the data
	...
	// //Generat a customMaterial based off the data and add it to the hashmap
	...
	// continue;
	// }
	// //If there isn't already an item in the core list called this one, add
	// it:
